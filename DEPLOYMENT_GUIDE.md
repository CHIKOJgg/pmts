...
Ожидается: **все тесты PASSED**. Запустите `pytest`, чтобы увидеть текущее количество тестов; набор тестов должен проходить полностью перед боевой торговлей. Если какие-то падают — проверьте, что виртуальное окружение активировано и все зависимости установлены.
